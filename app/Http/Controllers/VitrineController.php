...
class VitrineController extends Controller
{
    ...
    public function show2()
    {
        ...
        // $page = LinkPage::where('slug', $slug)->firstOrFail();

        return view('vitrines.generic4', [
            'pageTitle' => 'Acme Studio | Links',
            'name' => 'Acme Studio',
            'handle' => '@acmestudio',
            'bio' => 'Creative digital agency crafting brands, websites, and experiences that leave a mark.',
            'logo' => 'https://images.unsplash.com/photo-1614680376593-902f74cf0d41?w=240&h=240&fit=crop',
            'verified' => true,

            'socials' => [
                'facebook'  => 'https://facebook.com/acmestudio',
                'instagram' => 'https://instagram.com/acmestudio',
                'tiktok'    => 'https://tiktok.com/@acmestudio',
                'snapchat'  => 'https://snapchat.com/add/acmestudio',
            ...
            'services' => [
                ...
                [
                    'icon' => '📸',
                    'title' => 'Photography',
                    'description' => 'Product, portrait & event shoots',
                    'url' => '#portfolio',
                ],
                [
                    'icon' => '🎬',
                    'title' => 'Video Production',
                    'description' => 'Commercials, reels & motion graphics',
                    'url' => '#portfolio',
                ],
                [
                    'icon' => '📊',
                    'title' => 'Digital Marketing',
                    'description' => 'SEO, ads & growth campaigns',
                    'url' => '#portfolio',
                ],
            ],

            'whatsappNumber' => '1234567890', // Format: country code + number, no spaces
            'whatsappMessage' => 'Hi Acme Studio! I found your link page and would love to discuss a project.',
            'ctaText' => 'Chat on WhatsApp',
            'footerText' => '© 2026 Acme Studio. All rights reserved.',
        ]);
    }

    // app/Http/Controllers/PersonalPageController.php
    ...
    return view('vitrines.generic3', [
        ...
        'services' => [
            ...
            [
                'icon' => '⚡',
                'title' => 'Performance',
                'description' => 'Speed optimization & scaling'
            ],
            [
                'icon' => '🔒',
                'title' => 'Security',
            ...
            // Add 1-6 services - grid auto-breaks at 3
        ],
