...
<head>
    ...
    <title>VtrinTech | Votre Vitrine Virtuelle pour la Croissance</title>
...
<body class="antialiased selection:bg-accent-500 selection:text-white">
    ...
    <nav class="fixed w-full z-50 top-0 transition-all duration-300" id="navbar">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex-shrink-0 cursor-pointer group">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-[10px] text-void-400 tracking-widest uppercase -mt-1">Vitrine Virtuelle</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-8">
                        <a href="#features" class="text-void-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">Fonctionnalités</a>
                        <a href="#showcase" class="text-void-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">Exemples</a>
                        <a href="#pricing" class="text-void-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">Tarifs</a>
                    </div>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden glass-panel border-t border-white/5 absolute w-full">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="#showcase" class="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Exemples</a>
                <a href="#pricing" class="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Tarifs</a>
                <button class="w-full text-left bg-accent-500 text-white px-3 py-2 rounded-md text-base font-medium mt-4">Ouvrir Votre Vitrine</button>
            </div>
        </div>
    </nav>
    ...
    <section class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 animate-fade-in-up" style="animation-delay: 0.1s;">
                ...
                <span class="text-xs font-medium text-void-300 tracking-wide uppercase">La nouvelle façon d'exposer</span>
            </div>
            
            <h1 class="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8 animate-fade-in-up" style="animation-delay: 0.2s;">
                <span class="block gradient-text">Votre Entreprise.</span>
                <span class="block text-white mt-2">À Travers Une</span>
                <span class="block text-accent-400 mt-2">Vitrine Virtuelle.</span>
            </h1>
            ...
            <p class="mt-4 max-w-2xl mx-auto text-xl text-void-300 font-light leading-relaxed animate-fade-in-up" style="animation-delay: 0.3s;">
                VtrinTech transforme votre présence digitale en une vitrine élégante. 
                Une plateforme minimaliste qui expose votre entreprise au monde entier.
            </p>
            ...
            <div class="mt-20 relative max-w-5xl mx-auto animate-fade-in-up" style="animation-delay: 0.6s;">
                ...
                <div class="relative glass-panel rounded-xl overflow-hidden shadow-2xl border border-white/10 window-frame">
                    ...
                    <div class="bg-void-900/80 px-4 py-3 flex items-center gap-2 border-b border-white/5">
                        ...
                        <div class="flex-1 text-center flex items-center justify-center gap-2">
                            ...
                            <div class="inline-block px-3 py-1 rounded bg-void-800 text-xs text-void-400 font-mono">vtrin.tech/votre-entreprise</div>
                        </div>
                    </div>
                    <!-- Window Content -->
                    <div class="grid grid-cols-12 h-[400px] md:h-[500px]">
                        ...
                        <div class="hidden md:block col-span-3 bg-void-900/50 border-r border-white/5 p-4 space-y-4">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <span class="text-sm font-medium text-white">Votre Vitrine</span>
                            </div>
                            <div class="space-y-2">
                                <div class="h-8 w-full bg-accent-500/20 border border-accent-500/30 rounded flex items-center px-3 text-xs text-accent-300">Tableau de Bord</div>
                                <div class="h-8 w-full bg-white/5 rounded flex items-center px-3 text-xs text-void-400">Produits</div>
                                <div class="h-8 w-full bg-white/5 rounded flex items-center px-3 text-xs text-void-400">Statistiques</div>
                                <div class="h-8 w-full bg-white/5 rounded flex items-center px-3 text-xs text-void-400">Paramètres</div>
                            </div>
                        </div>
                        <!-- Main Display -->
                            ...
                            <div class="relative z-10 w-full max-w-lg">
                                <div class="bg-void-900/80 border border-white/10 rounded-lg p-6 backdrop-blur-sm">
                                    <div class="flex justify-between items-start mb-4">
                                        <div>
                                            <h3 class="text-white font-semibold">Collection en Vedette</h3>
                                            <p class="text-xs text-void-400 mt-1">Sélectionnée pour vos visiteurs</p>
                                        </div>
                                        <span class="px-2 py-1 bg-accent-500/20 text-accent-400 text-xs rounded">En Direct</span>
                                    </div>
                                    ...
                                    <div class="mt-4 flex gap-2">
                                        <button class="flex-1 py-2 bg-accent-500 hover:bg-accent-400 text-white rounded text-sm font-medium transition-colors">Voir Tout</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="absolute -bottom-4 -left-4 md:left-8 bg-void-800 border border-white/10 p-4 rounded-lg shadow-xl animate-float">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="text-xs text-void-400">Vues Aujourd'hui</div>
    ...
    <section id="features" class="py-24 relative">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Tout ce qu'il faut pour <br/><span class="text-accent-400">exposer votre entreprise.</span></h2>
                <p class="text-void-400 max-w-2xl mx-auto">Une solution complète de vitrine digitale. Présentez vos produits, services et votre histoire de marque à travers une vitrine virtuelle élégante.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group p-8 rounded-2xl bg-void-900/30 border border-white/5 hover:border-accent-500/30 transition-all duration-300 hover:bg-void-800/30 reveal">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-3">Vitrine Modulaire</h3>
                    <p class="text-void-400 leading-relaxed">Organisez votre devanture digitale avec une simplicité glisser-déposer. Créez la présentation parfaite pour votre marque.</p>
                </div>
                ...
                <div class="group p-8 rounded-2xl bg-void-900/30 border border-white/5 hover:border-accent-500/30 transition-all duration-300 hover:bg-void-800/30 reveal" style="transition-delay: 100ms;">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-3">Toujours Visible</h3>
                    <p class="text-void-400 leading-relaxed">Votre vitrine virtuelle est ouverte 24h/24 et 7j/7. Optimisée pour les moteurs de recherche et conçue pour convertir les visiteurs en clients.</p>
                </div>
                ...
                <div class="group p-8 rounded-2xl bg-void-900/30 border border-white/5 hover:border-accent-500/30 transition-all duration-300 hover:bg-void-800/30 reveal" style="transition-delay: 200ms;">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-3">Aperçu des Visiteurs</h3>
                    <p class="text-void-400 leading-relaxed">Voyez qui regarde par votre vitrine. Des analyses en temps réel vous aident à comprendre votre audience et à optimiser votre présentation.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 reveal">
                    <h2 class="text-3xl md:text-5xl font-bold text-white mb-6">Votre entreprise mérite <br/><span class="text-accent-400">d'être vue.</span></h2>
                    <p class="text-lg text-void-300 mb-8 leading-relaxed">
                        À l'ère digitale, votre site web est votre devanture. VtrinTech vous donne les outils pour créer une vitrine virtuelle époustouflante qui attire l'attention et stimule la croissance.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-4 p-4 bg-white/5 rounded-lg border border-white/5">
                            ...
                            <div>
                                <div class="text-white font-medium">Publication Instantanée</div>
                                <div class="text-sm text-void-400">En ligne en minutes, pas en jours</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 p-4 bg-white/5 rounded-lg border border-white/5">
                            <div class="w-10 h-10 rounded-full bg-accent-500/20 flex items-center justify-center text-accent-400">
                            ...
                            <div>
                                <div class="text-white font-medium">Optimisé Mobile</div>
                                <div class="text-sm text-void-400">Parfait sur tous les appareils</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:w-1/2 w-full reveal">
                    ...
                    <div class="relative mx-auto w-full max-w-md">
                            ...
                            <div class="bg-void-950 rounded-lg overflow-hidden">
                                <div class="h-48 bg-gradient-to-br from-void-800 to-void-900 flex items-center justify-center relative">
                                    ...
                                    <div class="relative z-10 text-center">
                                        ...
                                        <span class="text-white font-medium">Votre Marque</span>
                                    </div>
                                </div>
                        ...
                        <div class="absolute -bottom-6 -right-6 bg-void-800 border border-white/10 p-4 rounded-lg shadow-xl flex items-center gap-3 animate-float">
                            ...
                            <div>
                                <div class="text-xs text-void-400">Statut</div>
                                <div class="text-sm font-semibold text-white">En Ligne</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="pricing" class="py-24">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                <h2 class="text-3xl md:text-4xl font-bold text-white">Tarifs Simples</h2>
                <p class="mt-4 text-void-400">Ouvrez votre vitrine virtuelle aujourd'hui.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                <!-- Free Plan -->
                <div class="p-8 rounded-2xl bg-void-900/20 border border-white/5 hover:border-white/10 transition-all reveal">
                    <h3 class="text-lg font-medium text-white">Lèche-Vitrine</h3>
                    <div class="mt-4 flex items-baseline">
                        <span class="text-4xl font-bold text-white tracking-tight">0 €</span>
                        <span class="ml-1 text-void-400">/mois</span>
                    </div>
                    <p class="mt-4 text-sm text-void-400">Parfait pour tester votre première vitrine.</p>
                    ...
                    <button class="mt-8 w-full py-3 px-4 bg-white/5 border border-white/10 rounded-lg text-white font-medium hover:bg-white/10 transition-colors">Commencer Gratuitement</button>
                </div>
                ...
                <div class="p-8 rounded-2xl bg-void-800/50 border border-accent-500/30 relative transform md:-translate-y-4 shadow-2xl shadow-accent-500/10 reveal">
                    <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-accent-500 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">Le Plus Populaire</div>
                    <h3 class="text-lg font-medium text-white">Boutique</h3>
                    <div class="mt-4 flex items-baseline">
                        <span class="text-4xl font-bold text-white tracking-tight">19 €</span>
                        <span class="ml-1 text-void-400">/mois</span>
                    </div>
                    <p class="mt-4 text-sm text-void-400">Pour les entreprises prêtes à se développer.</p>
                    <ul class="mt-6 space-y-4">
                    ...
                    <button class="mt-8 w-full py-3 px-4 bg-accent-500 hover:bg-accent-600 rounded-lg text-white font-medium transition-colors shadow-lg shadow-accent-500/25">Ouvrir Votre Vitrine</button>
                </div>

                <!-- Enterprise Plan -->
                <div class="p-8 rounded-2xl bg-void-900/20 border border-white/5 hover:border-white/10 transition-all reveal">
                    <h3 class="text-lg font-medium text-white">Entreprise</h3>
                    <div class="mt-4 flex items-baseline">
                        <span class="text-4xl font-bold text-white tracking-tight">79 €</span>
                        <span class="ml-1 text-void-400">/mois</span>
                    </div>
                    <p class="mt-4 text-sm text-void-400">Plusieurs vitrines, une seule vision.</p>
                    <ul class="mt-6 space-y-4">
                        <li class="flex items-center text-sm text-void-300">
                            <svg class="w-4 h-4 text-accent-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            Membres d'Équipe (10)
                    ...
                    <button class="mt-8 w-full py-3 px-4 bg-white/5 border border-white/10 rounded-lg text-white font-medium hover:bg-white/10 transition-colors">Contacter les Ventes</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 text-center relative z-10 reveal">
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Prêt à ouvrir votre vitrine ?</h2>
            <p class="text-xl text-void-300 mb-10">Rejoignez des milliers d'entreprises qui exposent leur histoire avec VtrinTech.</p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <input type="email" placeholder="Votre adresse email" class="px-6 py-4 rounded-full bg-white/5 border border-white/10 text-white placeholder-void-400 focus:outline-none focus:border-accent-500 w-full sm:w-80 transition-colors">
            ...
            <p class="mt-4 text-xs text-void-500">Aucune carte de crédit requise. Essai gratuit de 14 jours.</p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                <div class="col-span-2 md:col-span-1">
                    ...
                    <p class="text-sm text-void-500">
                        Votre vitrine virtuelle vers le monde digital. Exposez votre entreprise avec élégance.
                    </p>
                </div>
                <div>
                    <h4 class="text-white font-medium mb-4">Produit</h4>
                    <ul class="space-y-2 text-sm text-void-400">
                        <li><a href="#" class="hover:text-accent-400 transition-colors">Fonctionnalités</a></li>
                        <li><a href="#" class="hover:text-accent-400 transition-colors">Modèles</a></li>
                        <li><a href="#" class="hover:text-accent-400 transition-colors">Tarifs</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-white font-medium mb-4">Entreprise</h4>
                    <ul class="space-y-2 text-sm text-void-400">
                        <li><a href="#" class="hover:text-accent-400 transition-colors">À Propos</a></li>
                        <li><a href="#" class="hover:text-accent-400 transition-colors">Blog</a></li>
                        <li><a href="#" class="hover:text-accent-400 transition-colors">Carrières</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-white font-medium mb-4">Légal</h4>
                    <ul class="space-y-2 text-sm text-void-400">
                        <li><a href="#" class="hover:text-accent-400 transition-colors">Confidentialité</a></li>
                        <li><a href="#" class="hover:text-accent-400 transition-colors">Conditions</a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-xs text-void-600">&copy; 2026 VtrinTech Inc. Tous droits réservés.</p>
